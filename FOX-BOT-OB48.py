...
{COLOR_YELLOW}⇾  Version: 2.0 | By: @FOXX⇽
{COLOR_YELLOW}⇾  Authentication: {COLOR_GREEN}bot:bot{COLOR_RESET}
{COLOR_YELLOW}⇾Tool Name: {COLOR_RED}{COLOR_UNDERLINE}FOX-BOT-X{COLOR_RESET}
""")
####################################
print(f"========================================================================")
install = input(f"{COLOR_BLUE}{COLOR_BOLD}[1+]If the offices are already loaded:\n[2+]If you want to load the offices:    \n{COLOR_RESET}")
print(f"========================================================================")
if install != "1":
    libraries = [
        "requests",
